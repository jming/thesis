...
# 		python get_anchors/learn_topics.py cui_counter.mat.trunc.mat get_anchors/settings.example cui_list.txt.trunc $K $loss result6/result\_out.$K
...
do
	echo 'translating $K'
	python get_result/translate.py result5/result\_out.$K.topwords result5/result\_out.$K.topwords.translate cui_dict.txt
done