...
python get_q/getq.py get_q/joy_all_posts.txt get_q/mrsty_filtered.csv cui_counter.mat cui_list.txt
...
# 		python get_anchors/learn_topics.py cui_counter.mat.trunc.mat get_anchors/settings.example cui_list.txt.trunc $K $loss result7/result\_out.$K
...
# do
# 	echo 'translating $K'
# 	python get_result/translate.py result7/result\_out.$K.topwords result7/result\_out.$K.topwords.translate cui_dict.txt
# done